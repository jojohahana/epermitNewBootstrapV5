  ...
  <body class="landing-wrraper">
    ...
    <div class="page-wrapper landing-page">
      ...
      <div class="page-body-wrapper">
              ...
              <div class="col-12">
                <nav class="navbar navbar-light p-0" id="navbar-example2"><a class="navbar-brand" href="javascript:void(0)"> <img class="img-fluid" src="{{ asset('vendor/images/logo/LogoEpermit.png') }}" alt=""></a>
                  <ul class="landing-menu nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('epermit/checksakit') }}">Check Izin Sakit</a></li>
                  </ul>
        ...
        <!-- header end-->
        <!--home section start-->
        <section class="landing-home section-pb-space" id="home"><img class="img-fluid bg-img-cover" src="{{ asset('vendor/images/landing/landing-home/home-bg2.jpg') }}" alt="">
          <div class="custom-container">
            <div class="row">
              <div class="col-12">
                <div class="landing-home-contain">
                  <div>
                    <div class="landing-logo"><img class="img-fluid" src="{{ asset('vendor/images/landing/landing-home/logo.png') }}" alt=""></div>
                    <!-- <h1>E-PERMIT</h1> -->
